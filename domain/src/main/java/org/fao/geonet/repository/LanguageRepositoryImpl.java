...
/**
 * Implement custom repository methods in LanguageRepositoryCustom User: Jesse
 * Date: 8/30/13 Time: 8:22 AM
 */
public class LanguageRepositoryImpl extends GeonetRepositoryImpl<Language, String> implements LanguageRepositoryCustom {
