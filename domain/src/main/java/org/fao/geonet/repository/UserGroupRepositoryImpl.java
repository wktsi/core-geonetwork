 ...
 * @author Jesse
 */
public class UserGroupRepositoryImpl extends GeonetRepositoryImpl<UserGroup, UserGroupId>
	...
	public int deleteAllByIdAttribute(SingularAttribute<UserGroupId, Integer> idAttribute, Collection<Integer> ids) {
		...
		final String qlString = "DELETE FROM " + UserGroup.class.getSimpleName() + " WHERE " + userIdPath + " IN ("
				+ idString + ")";
