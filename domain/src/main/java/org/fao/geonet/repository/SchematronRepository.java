 ...
 * @author delawen
 */
public interface SchematronRepository extends GeonetRepository<Schematron, Integer>,
		CrudRepository<Schematron, Integer>, JpaRepository<Schematron, Integer>, JpaSpecificationExecutor<Schematron> {
	/**
