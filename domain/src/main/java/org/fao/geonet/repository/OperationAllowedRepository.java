...
public interface OperationAllowedRepository
		extends GeonetRepository<OperationAllowed, OperationAllowedId>, OperationAllowedRepositoryCustom,
		JpaRepository<OperationAllowed, OperationAllowedId>, JpaSpecificationExecutor<OperationAllowed> {
	...
	/**
	 * Find the one OperationAllowed entity by the operation, metadata and group ids
	 ...
	 * @param operationId
	 *            the operationid
	 * @return the one OperationAllowed entity by the operation, metadata and group
	 *         ids (or null if not found).
	 */
	@Nullable
