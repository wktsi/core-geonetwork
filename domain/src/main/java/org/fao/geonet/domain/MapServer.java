...
public class MapServer extends GeonetEntity {
	...
	@Transient
	private static final long serialVersionUID = -2515548468116639557L;

	@Transient
	protected static final String ID_SEQ_NAME = "mapserver_id_seq";
    ...
    private Character _pushstyleinworkspace = Constants.YN_FALSE;
     ...
     */
    public MapServer setId(Integer id) {
        this._id = id;
        return this;
    }
    ...
    protected Character getPushStyleInWorkspace_JpaWorkaround() {
        return _pushstyleinworkspace;
    }

    protected void setPushStyleInWorkspace_JpaWorkaround(Character _pushStyleInWorkspace) {
