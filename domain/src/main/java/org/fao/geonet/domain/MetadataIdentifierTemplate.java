...
public class MetadataIdentifierTemplate extends GeonetEntity {
	private static final long serialVersionUID = 6415507441093072178L;
    ...
    private Character _systemProvided = 'n';
     ...
     */
    public MetadataIdentifierTemplate setId(Integer id) {
        this._id = id;
        return this;
    }
    ...
    protected Character getSystemProvided_JPAWorkaround() {
     ...
     */
    protected void setSystemProvided_JPAWorkaround(Character _default) {
