...
<xsl:attribute name="href">../../../../../catalog/views/snig/css/Pretty_AzulNoBranco_Portal.css</xsl:attribute>
  ...
  <xsl:template match="*/gmd:identificationInfo/srv:SV_ServiceIdentification | */identificationInfo/SV_ServiceIdentification">
    <div class="caixa">
      ...
      <div class="caixaElemento">
        <span class="elemento">Acoplamento: </span>
        <span class="textoElemento">
          <xsl:value-of select="srv:couplingType/srv:SV_CouplingType | couplingType/SV_CouplingType"/>
        </span>
      </div>
      <xsl:if test="string(srv:operatesOn/@xlink:href | operatesOn/@xlink:href)">
      <div class="caixa">
      	<div class="tituloCaixa">Recurso Associado</div>
		<xsl:for-each select="srv:operatesOn | operatesOn">
	   		<div class="caixaElemento">          
